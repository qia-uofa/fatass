...
import { homeDir, readCurrentNode, topologyDir } from "./workspaceRoot";
...
export type FileItemKind = "file" | "dir" | "root" | "chainItem";
...
export class NodeViewProvider implements vscode.TreeDataProvider<FileItem> {
  ...
  private static readonly HIDDEN_NAMES = new Set(["__pycache__", ".gitkeep", ".next", ".entry"]);
  ...
  private listChainItem(dir: string): FileItem[] {
  ...
  private listChainAware(dir: string, label: string): FileItem[] {
