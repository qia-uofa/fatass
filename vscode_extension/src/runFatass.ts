...
const replTerminals = new WeakSet<vscode.Terminal>();
...
export function isInShellRepl(terminal?: vscode.Terminal): boolean {
...
function runInTerminal(t: vscode.Terminal, commandLine: string, onDone?: () => void): void {
