import fatass
from fatass.topology.archive.seminar_essay.materials.papers.subject import (
    Subject as Subject,
)
...
def build(subject: Subject):
    fatass.free(
        silent=True,
        model="sonnet",
        tools="Read,Write,Edit,Glob,Grep,Bash",  # Bash: reading paper.pdf needs it, else Read misreads it as password-protected
        readable=[subject],
        prompt=(
